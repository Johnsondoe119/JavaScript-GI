...
let john = 1999;
let jay = 1968;
let results = john - jay;

console.log("The difference between John and Jay is", results);


// Easy
let name1 = "Didier Drogba";
let name2 = "Thiery Henry";
let numDif = name1.length - name2.length;
